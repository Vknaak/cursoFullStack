...
export class ClientesService {
  ...
  autalizar(cliente: Cliente): Observable<any> {
    return this.http.put<Cliente>(`http://localhost:8080/sistema-vendas/api/clientes/${cliente.id}`, cliente);
  }
  ...
  deletar(cliente: Cliente): Observable<any>{
    return this.http.delete<any>(`http://localhost:8080/sistema-vendas/api/clientes/${cliente.id}`)
  }
}
